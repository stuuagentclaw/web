...
describe('YieldMachine Types', () => {
  it('YieldMachineContext type is structurally valid', () => {
    const context: YieldMachineContext = {
      sellAsset: {
  ...
  it('YieldMachineEvent discriminated union covers all event types', () => {
    const events: YieldMachineEvent[] = [
      {
        type: 'SET_SELL_ASSET',
        asset: {
          assetId: 'eip155:1/slip44:60',
  ...
  it('chainType supports all chain types', () => {
    const chainTypes: YieldMachineContext['chainType'][] = [
      'evm',
      'utxo',
      'solana',
      'cosmos',
